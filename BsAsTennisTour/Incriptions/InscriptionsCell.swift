...
class InscriptionsCell: UITableViewCell {
    ...
    func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            containerPhotoHeader.topAnchor.constraint(equalTo: topAnchor,constant: 30),
            containerPhotoHeader.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 30),
